...
import {MostraPersoneComponent} from './components/mostra-persone/mostra-persone.component';

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Es1Component, BananaInScatolaComponent, Es2Component, MostraPersoneComponent],
